...
#define WZ_CAE     1
#if WZ_CAE
#define WZ_CAE_LAMBDA 1
#define WZ_CAE_MB_REENCODE 3
#define WZ_CAE_MODE        1
#define WZ_CAE_FRAME_REENCODE 1
#define WZ_CAE_CTX 1
#endif //WZ_CAE
...
typedef struct x264_param_t
{
...
#if WZ_CAE
    float f_max_ssd;  //for each 4x4 block
    float f_min_ssd;  //for each 4x4 block
    ...
    float f_frame_maxssd; //for each frame, consider 4x4 and 8x8 block
    float f_frame_minssd; //for each frame, consider 4x4 and 8x8 block
    float f_psnr_constraint; //calc from f_frame_maxssd
#endif
#endif
