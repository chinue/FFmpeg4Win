...
static struct option long_options[] =
{
    ...
    { "ssdmax", required_argument, NULL, 0 },
    { "ssdmin", required_argument, NULL, 0 },
    { "ssimmin",       required_argument, NULL, 0 },
    { "psnrmin",       required_argument, NULL, 0 },
    { "maxbits",       required_argument, NULL, 0 },
#endif
#if WZ_CAE_LAMBDA
    { "lambda-factor", required_argument, NULL, 1 },
#endif
#if WZ_CAE_FRAME_REENCODE
    { "frame-ssdmax", required_argument, NULL, 0 },
    { "frame-ssdmin", required_argument, NULL, 0 },
#endif
#endif //WZ_CAE
